...
#[inline]
pub fn get_approximated_cardinality_with_64_registers_and_6_bits(words: &[u32; 13]) -> (usize, f32) {
	...
	let [register_60, register_61, register_62, register_63, _] = split_registers::<5>(words[12]);
