...
#[inline]
pub fn get_approximated_cardinality_with_128_registers_and_5_bits(words: &[u32; 22]) -> (usize, f32) {
	...
	number_of_zero_registers += (register_126 == 0) as usize + (register_127 == 0) as usize;
