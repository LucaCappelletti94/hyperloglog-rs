...
#[inline]
pub fn get_approximated_cardinality_with_256_registers_and_5_bits(words: &[u32; 43]) -> f32 {
	...
	let [register_252, register_253, register_254, register_255, _, _] = split_registers::<6>(words[42]);
