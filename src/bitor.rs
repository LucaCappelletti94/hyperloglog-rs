...
impl<const PRECISION: usize, const BITS: usize> BitOrAssign<Self> for HyperLogLog<PRECISION, BITS>
where
...
impl<const PRECISION: usize, const BITS: usize> BitOr<Self> for HyperLogLog<PRECISION, BITS>
where
    [(); ceil(1 << PRECISION, 32 / BITS)]:,
{
    type Output = Self;
