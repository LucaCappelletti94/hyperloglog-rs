...
impl Precision<1> for Precision4 {
...
impl Precision<2> for Precision4 {
    type NumberOfZeros = u8;
    const EXPONENT: usize = 4;
    const MAXIMAL: usize = u8::MAX as usize;
    type SmallCorrrections = [f32; 16];
...
impl Precision<3> for Precision4 {
    type NumberOfZeros = u8;
    const EXPONENT: usize = 4;
    const MAXIMAL: usize = u8::MAX as usize;
    type SmallCorrrections = [f32; 16];
...
impl Precision<1> for Precision5 {
    type NumberOfZeros = u8;
...
impl Precision<2> for Precision5 {
    type NumberOfZeros = u8;
    const EXPONENT: usize = 5;
    const MAXIMAL: usize = u8::MAX as usize;
    type SmallCorrrections = [f32; 32];
...
impl Precision<3> for Precision5 {
    type NumberOfZeros = u8;
    const EXPONENT: usize = 5;
    const MAXIMAL: usize = u8::MAX as usize;
    type SmallCorrrections = [f32; 32];
...
impl Precision<1> for Precision6 {
    type NumberOfZeros = u8;
...
impl Precision<2> for Precision6 {
    type NumberOfZeros = u8;
    const EXPONENT: usize = 6;
    const MAXIMAL: usize = u8::MAX as usize;
    type SmallCorrrections = [f32; 64];
...
impl Precision<3> for Precision6 {
    type NumberOfZeros = u8;
    const EXPONENT: usize = 6;
    const MAXIMAL: usize = u8::MAX as usize;
    type SmallCorrrections = [f32; 64];
...
impl Precision<1> for Precision7 {
    type NumberOfZeros = u8;
...
impl Precision<2> for Precision7 {
    type NumberOfZeros = u8;
    const EXPONENT: usize = 7;
    const MAXIMAL: usize = u8::MAX as usize;
    type SmallCorrrections = [f32; 128];
...
impl Precision<3> for Precision7 {
    type NumberOfZeros = u8;
    const EXPONENT: usize = 7;
    const MAXIMAL: usize = u8::MAX as usize;
    type SmallCorrrections = [f32; 128];
...
impl Precision<1> for Precision8 {
...
impl Precision<2> for Precision8 {
    type NumberOfZeros = u16;
    const EXPONENT: usize = 8;
    const MAXIMAL: usize = u16::MAX as usize;
    type SmallCorrrections = [f32; 256];
...
impl Precision<3> for Precision8 {
    type NumberOfZeros = u16;
    const EXPONENT: usize = 8;
    const MAXIMAL: usize = u16::MAX as usize;
    type SmallCorrrections = [f32; 256];
...
impl Precision<1> for Precision9 {
    type NumberOfZeros = u16;
...
impl Precision<2> for Precision9 {
    type NumberOfZeros = u16;
    const EXPONENT: usize = 9;
    const MAXIMAL: usize = 65536;
    type SmallCorrrections = [f32; 512];
...
impl Precision<3> for Precision9 {
    type NumberOfZeros = u16;
    const EXPONENT: usize = 9;
    const MAXIMAL: usize = 65536;
    type SmallCorrrections = [f32; 512];
...
impl Precision<1> for Precision10 {
    type NumberOfZeros = u16;
...
impl Precision<2> for Precision10 {
    type NumberOfZeros = u16;
    const EXPONENT: usize = 10;
    const MAXIMAL: usize = u16::MAX as usize;
    type SmallCorrrections = [f32; 1024];
...
impl Precision<3> for Precision10 {
    type NumberOfZeros = u16;
    const EXPONENT: usize = 10;
    const MAXIMAL: usize = u16::MAX as usize;
    type SmallCorrrections = [f32; 1024];
...
impl Precision<1> for Precision11 {
    type NumberOfZeros = u16;
...
impl Precision<2> for Precision11 {
    type NumberOfZeros = u16;
    const EXPONENT: usize = 11;
    const MAXIMAL: usize = u16::MAX as usize;
    type SmallCorrrections = [f32; 2048];
...
impl Precision<3> for Precision11 {
    type NumberOfZeros = u16;
    const EXPONENT: usize = 11;
    const MAXIMAL: usize = u16::MAX as usize;
    type SmallCorrrections = [f32; 2048];
...
impl Precision<1> for Precision12 {
    type NumberOfZeros = u16;
...
impl Precision<2> for Precision12 {
    type NumberOfZeros = u16;
    const EXPONENT: usize = 12;
    const MAXIMAL: usize = u16::MAX as usize;
    type SmallCorrrections = [f32; 4096];
...
impl Precision<3> for Precision12 {
    type NumberOfZeros = u16;
    const EXPONENT: usize = 12;
    const MAXIMAL: usize = u16::MAX as usize;
    type SmallCorrrections = [f32; 4096];
...
impl Precision<1> for Precision13 {
    type NumberOfZeros = u16;
...
impl Precision<2> for Precision13 {
    type NumberOfZeros = u16;
    const EXPONENT: usize = 13;
    const MAXIMAL: usize = u16::MAX as usize;
    type SmallCorrrections = [f32; 8192];
...
impl Precision<3> for Precision13 {
    type NumberOfZeros = u16;
    const EXPONENT: usize = 13;
    const MAXIMAL: usize = u16::MAX as usize;
    type SmallCorrrections = [f32; 8192];
...
impl Precision<1> for Precision14 {
    type NumberOfZeros = u16;
...
impl Precision<2> for Precision14 {
    type NumberOfZeros = u16;
    const EXPONENT: usize = 14;
    const MAXIMAL: usize = u16::MAX as usize;
    type SmallCorrrections = [f32; 16384];
...
impl Precision<3> for Precision14 {
    type NumberOfZeros = u16;
    const EXPONENT: usize = 14;
    const MAXIMAL: usize = u16::MAX as usize;
    type SmallCorrrections = [f32; 16384];
...
impl Precision<1> for Precision15 {
    type NumberOfZeros = u16;
...
impl Precision<2> for Precision15 {
    type NumberOfZeros = u16;
    const EXPONENT: usize = 15;
    const MAXIMAL: usize = u16::MAX as usize;
    type SmallCorrrections = [f32; 32768];
...
impl Precision<3> for Precision15 {
    type NumberOfZeros = u16;
    const EXPONENT: usize = 15;
    const MAXIMAL: usize = u16::MAX as usize;
    type SmallCorrrections = [f32; 32768];
...
impl Precision<1> for Precision16 {
...
impl Precision<2> for Precision16 {
    // For Precision 16, we are still able to use a u16, but we
    // will loose the ability to count one of the registers.
    type NumberOfZeros = u32;
    const EXPONENT: usize = 16;
...
impl Precision<3> for Precision16 {
    // For Precision 16, we are still able to use a u16, but we
    // will loose the ability to count one of the registers.
    type NumberOfZeros = u32;
    const EXPONENT: usize = 16;
...
impl Precision<1> for Precision17 {
    type NumberOfZeros = u32;
...
impl Precision<2> for Precision17 {
    type NumberOfZeros = u32;
    const EXPONENT: usize = 17;
    const MAXIMAL: usize = u32::MAX as usize;
    type SmallCorrrections = [f32; 131072];
...
impl Precision<3> for Precision17 {
    type NumberOfZeros = u32;
    const EXPONENT: usize = 17;
    const MAXIMAL: usize = u32::MAX as usize;
    type SmallCorrrections = [f32; 131072];
...
impl Precision<1> for Precision18 {
    type NumberOfZeros = u32;
...
impl Precision<2> for Precision18 {
    type NumberOfZeros = u32;
    const EXPONENT: usize = 18;
    const MAXIMAL: usize = u32::MAX as usize;
    type SmallCorrrections = [f32; 262144];
...
impl Precision<3> for Precision18 {
    type NumberOfZeros = u32;
    const EXPONENT: usize = 18;
    const MAXIMAL: usize = u32::MAX as usize;
    type SmallCorrrections = [f32; 262144];
