...
fuzz_target!(|data: FuzzCase| {
    ...
    let mut left_array: HyperLogLogArray<Precision13, BITS, N> = HyperLogLogArray::default();
    let mut right_array: HyperLogLogArray<Precision13, BITS, N> = HyperLogLogArray::default();
