...
fn test_hyper_spheres(
    ...
    let (second_overlap_sets, left_shell, right_shell): ([[usize; 3]; 3], usize, usize) =
        HashSet::overlap_matrix_and_outer_difference_shells_cardinality(&left_sets, &right_sets);
