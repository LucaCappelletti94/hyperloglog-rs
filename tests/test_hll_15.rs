...
#[test]
pub fn test_hyper_log_log_at_precision_15_and_bits_4() {
    type PRECISION = Precision15;
    const BITS: usize = 4;

    for number_of_elements in [5, 10, 15, 100, 200, 1000, 10_000, 100_000, 1_000_000] {
        if BITS <= 4 && 15 <= 5 && number_of_elements > 10_000 {
            continue;
        }
...
#[test]
pub fn test_hyper_log_log_at_precision_15_and_bits_5() {
    type PRECISION = Precision15;
    const BITS: usize = 5;
...
#[test]
pub fn test_hyper_log_log_at_precision_15_and_bits_6() {
    type PRECISION = Precision15;
    const BITS: usize = 6;
